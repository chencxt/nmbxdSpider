...
from img_spider import fetch_page
from img_spider import parse_page
from img_spider import download_image
from img_spider import save_to_excel
from img_spider import imgmain
...
def main():
    ...
    save_to_excel(main_title, all_image_paths)
    print(
...
def xls2docx(thread_id, main_title, save_date):
    ...
    docx_path = default_path + '/' + f"{input_file_name} - MainText.docx"  # 修改点4/4 输出文件名，不用管
