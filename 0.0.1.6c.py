...
def getData(baseurl):
    ...
    while True:
        ...
        if page == 1 and main_item:
            ...
            main_title = re.findall(findmaintitle, str(main_item))[0] if re.findall(findmaintitle, str(main_item)) else ""
            main_email = re.findall(findmainemail, str(main_item))[0] if re.findall(findmainemail, str(main_item)) else ""
